...
const Payment = () => {
  return (
    ...
    />
    <div className="paystack-color-bar bg-white" />
        ...
        <div className="col-md-5 offset-md-4 bg-white" style={{
          ...
          <div className="header">
            <div className="page-info">
              <h3 id="page-name" className="page-name bg-white">
                Developer Service Payment
              </h3>
              <p className="company-name bg-white">
                BY <span id="company-name">Durabyte Studio</span>
              </p>
            </div>
            <div className="page-description bg-white">
