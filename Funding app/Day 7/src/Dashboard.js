              ...
              <li className="nav-item">
                <a href="">
                  <div className="menu-icon">
                    ...
                    <Link to="/analysis" className='text-decoration-none'>Tasks</Link></span>
                  </div>
                </a>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <a href="">
                  <div className="menu-icon">
                    ...
                    <span className="nav-label">
                    <Link to = "/help" className='text-decoration-none'>Help</Link></span>
                  </div>
                </a>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <a href="">
                  <div className="menu-icon">
                    ...
                    <span className="nav-label">
                    <Link to="/analysis" className='text-decoration-none'>Graph</Link></span>
                  </div>
                </a>
              </li>
              <li className="nav-item">
          ...
          <div className="task-calendar">
            ...
            <div className="taskhead">
              ...
              <div className="calendar">
                <h3>Let's Make The World A Better Place To Live In!</h3>
                <div className="week d-flex">
                  <p>“There is nothing more beautiful than someone who goes out of their way to make life beautiful for others.” “Volunteers don't get paid, not because they're worthless, but because they're priceless.” “Fundraising is the gentle art of teaching the joy of giving.” Charity begins at home but should not end there.”</p>
                </div>
              </div>
              {/* calendar ends */}
            </div>
