          ...
          <div className="task-calendar">
            ...
            <div className="taskhead">
              ...
              <div className="calendar">
                <h3>We Make The Hopes Into Actions!</h3>
                <div className="week d-flex">
                  <p>In the event of a calamity of a severe nature, where the requirement of funds for 
                  relief operations.Volunteering doesn't just help those around you, it helps you stand a better chance of being healthier and happier. Our Mission is to bring volunteers and organisations together to share time, skills and passion to promote India's social development.</p>
                </div>
              </div>
              {/* calendar ends */}
            </div>
            ...
            <div className="task-block">
              ...
              <div className="task-card">
                <div className="task-header">
                  <h3>Soil Erosion In Rajasthan</h3>
